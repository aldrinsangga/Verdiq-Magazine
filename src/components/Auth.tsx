...
import { login, signup, requestPasswordReset, saveSession, sendVerificationEmail, loginWithGoogle } from '../authClient';
      ...
      <form onSubmit={handleAuth} className="space-y-4">
        ...
        {mode !== 'forgot' && (
          <button
            ...
            disabled={loading}
            className="w-full bg-white hover:bg-slate-100 text-slate-950 font-black py-4 rounded-2xl transition-all flex items-center justify-center gap-3 text-sm uppercase tracking-widest"
