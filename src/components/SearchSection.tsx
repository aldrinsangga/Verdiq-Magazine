                    ...
                    container.innerHTML = `
                      <div class="flex flex-col items-center justify-center p-12 text-center">
                        ...
                        <p class="text-slate-500 text-[10px] leading-relaxed max-w-[200px]">
                          Please upload your photo to the <b>public</b> folder and rename it to <b>editorial-feature-v3.jpg</b>
                        </p>
                      </div>
                    `;
                  }
                      ...
                      container.innerHTML = `
                        <div class="absolute inset-0 flex flex-col items-center justify-center p-6 text-center">
                          ...
                          <p class="text-slate-500 text-[8px] leading-tight max-w-[120px]">
                            Upload to <b>public</b> as <b>podcast-feature-v3.jpg</b>
                          </p>
                        </div>
                      `;
                    }
